...
class MoveTriangle:
    ...
    def turn_120_degrees(self):
        ...
        while not rospy.is_shutdown():
            ...
            if abs(cumulative_angle) >= math.radians(120):
                t.angular.z = 0.0
    ...
    def move_in_triangle(self):
        for _ in range(3): #Repeat for four sides of the square 
            self.move_straight_for_distance(distance = 2) #Move straight 
            self.turn_120_degrees() #Turn 90 degrees 

if __name__ == '__main__':
    move_triangle = MoveTriangle() #Create MoveSquare instance 
    move_triangle.move_in_triangle() #Start moving in a square
