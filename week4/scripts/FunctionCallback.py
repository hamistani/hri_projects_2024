...
class FunctionCallback:
    ...
    def function_callback(self, msg):
        ...
        try: 
            head_to_torso = self.tfBuffer.lookup_transform('torso', 'HeadYaw', rospy.Time())
            rospy.loginfo('Success, head to torso transform has been gotten')

            hand_to_torso = self.tfBuffer.lookup_transfrom('torso', 'l_gripper', rospy.Time())
        ...
        head_to_hand_vector = geometry_msgs.msg.Vector3(
            hand_to_torso.transform.translation.x - head_to_torso.transfrom.translation.x,
            hand_to_torso.transform.translation.y - head_to_torso.transfrom.translation.y, 
            hand_to_torso.transform.translation.z - head_to_torso.transfrom.translation.z
        )
        ...
        try:
            hand_to_head_transform = self.tfBuffer.lookup_transform('HeadYaw', 'LHand', rospy.Time())
